...
export function buildArtifactInstruction(
  ...
  return [
    ...
    "Never call location.reload(), window.location.reload(), or create a self-refresh loop. The Preview is a persistent iframe: implement routes, back actions, resets, and content changes by updating DOM or application state in place.",
